...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('firstname' , 'lastname' ,'email', 'password', 'is_active', 'is_admin' , 'phone_number' , 'role')
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('email' ,'firstname', 'lastname' , 'is_admin' , 'is_active' , 'phone_number' , 'role')   #'is_email_verified'   'phone_number'
    list_filter = ('is_admin' , 'email' ,'firstname', 'lastname' , 'phone_number' , 'role')
    fieldsets=(
        (None, {'fields': ('email', 'password')}),
        ('Personal info', {'fields': ('firstname', 'lastname','phone_number' , 'role')}), ## 'phone_number'
